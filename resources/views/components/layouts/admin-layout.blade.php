    ...
    <body>
        ...
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="/admin"><span>Lullaby</span></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    class="sidebar-item has-sub {{ Request::is('admin/products', 'admin/category', 'transaction') ? 'active' : '' }}">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item">
                            <a href="/admin/category">Create Categories</a>
                        </li>
                        <li class="submenu-item">
